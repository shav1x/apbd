...
using User.MinimalApi.Contracts.Requests;
using User.MinimalApi.Data;
using User.MinimalApi.Models;

namespace User.MinimalApi.Controllers;

[ApiController]
[Route("api/users")]
public class UsersController : ControllerBase
{
    private readonly List<Models.User> _users = UsersRepository.Users;
    ...
    public IActionResult Create(CreateUserRequest request)
    {
        ...
        var newUser = new Models.User { Id = id, FullName = request.FullName, Email = request.Email };
        _users.Add(newUser);
